...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'premium_activation_codes' AND policyname = 'Admins can view all codes') THEN
    DROP POLICY "Admins can view all codes" ON premium_activation_codes;
  END IF;
  
  IF EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'premium_activation_codes' AND policyname = 'Users can view own codes') THEN
    DROP POLICY "Users can view own codes" ON premium_activation_codes;
  END IF;
  
  IF EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'premium_activation_codes' AND policyname = 'Admins can insert codes') THEN
    DROP POLICY "Admins can insert codes" ON premium_activation_codes;
  END IF;
  
  IF EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'premium_activation_codes' AND policyname = 'Admins can update all codes') THEN
    DROP POLICY "Admins can update all codes" ON premium_activation_codes;
  END IF;
  
  IF EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'premium_activation_codes' AND policyname = 'Users can update own codes') THEN
    DROP POLICY "Users can update own codes" ON premium_activation_codes;
  END IF;
  
  IF EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'premium_activation_codes' AND policyname = 'Admins can delete codes') THEN
    DROP POLICY "Admins can delete codes" ON premium_activation_codes;
  END IF;
END
$$;
