/*
  # Ajout de la table pour les codes d'activation premium

  1. Nouvelles Tables
    - `premium_activation_codes` : Stockage des codes d'activation premium
    
  2. Sécurité
    - Enable RLS sur la table
    - Politiques pour que seuls les administrateurs puissent gérer les codes
    - Politiques pour que les utilisateurs puissent valider leurs propres codes
*/
