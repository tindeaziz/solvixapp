      ...
      {showLogoutModal && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="modal-container inline-block align-bottom bg-white rounded-xl text-left overflow-hidden shadow-solvix-lg transform transition-all sm:my-8 sm:align-middle">
        ...
        <div className="p-3 sm:p-4 border-t border-gray-200">
          <div className="relative">
            ...
            >
              ...
              {!loadingUserInfo && (
                <ChevronDown className={`h-3 w-3 sm:h-4 sm:w-4 text-gray-400 transition-transform duration-200 flex-shrink-0 ${userMenuOpen ? 'rotate-180' : ''}`} />
              )}
            </button>
            ...
            {userMenuOpen && !loadingUserInfo && (
              <div className="absolute bottom-full left-0 right-0 mb-2 bg-white border border-gray-200 rounded-xl shadow-solvix py-1">
                ...
                <button
                  ...
                  className="w-full flex items-center px-3 sm:px-4 py-2 text-xs sm:text-sm text-gray-700 hover:bg-solvix-light transition-colors duration-200 font-inter"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center px-3 sm:px-4 py-2 text-xs sm:text-sm text-solvix-error hover:bg-red-50 transition-colors duration-200 font-inter"
                >
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="header">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="hidden md:flex items-center space-x-2 text-xs sm:text-sm text-gray-500 font-inter">
              {loadingUserInfo ? (
                <div className="h-3 sm:h-4 bg-gray-200 rounded w-24 sm:w-32 animate-pulse"></div>
              ) : (
                <span className="truncate">Dernière connexion: {userInfo.lastConnection}</span>
              )}
            </div>
            ...
            <div className="relative hidden lg:block">
              ...
              >
                ...
                {!loadingUserInfo && (
                  <ChevronDown className={`h-3 w-3 sm:h-4 sm:w-4 text-gray-400 transition-transform duration-200 ${userMenuOpen ? 'rotate-180' : ''}`} />
                )}
              </button>

              {userMenuOpen && !loadingUserInfo && (
                <div className="absolute right-0 top-full mt-2 w-56 sm:w-64 bg-white border border-gray-200 rounded-xl shadow-solvix-lg py-1 z-50">
                  <div className="px-3 sm:px-4 py-2 sm:py-3 border-b border-gray-100">
                    <div className="flex items-center space-x-2 sm:space-x-3">
                      {renderUserAvatar('md')}
                      <div className="flex-1 min-w-0">
